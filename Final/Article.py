...
class Article(Base):
    ...
    submitted: Mapped[Optional[bool]]
    ...
    profile: Mapped["Profile"] = relationship(back_populates="articles")
    ...
    def __init__(self, article_id, profile_id, editor_id, title, body, edited, submitted, approved, likes, dislikes,
                 comments,
                 date_created, date_updated=None):
